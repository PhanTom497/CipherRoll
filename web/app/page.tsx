        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-end justify-between gap-12 pt-8 md:pt-12">
          <div className="max-w-3xl text-left">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              >
                <Link href="https://youtu.be/uBAilNYfFIw" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 bg-transparent text-[#e4e4e5] px-6 py-2.5 rounded-full font-medium border border-white/20 hover:bg-white/10 transition-colors text-sm">
